...
public class Mage extends Player implements ClassInterface{
    ...
    public Mage(){
        ...
        this.points = 10;
        this.expBar = 30;
        this.multiplier.put("Strength multiplier", 1.00f);
        this.multiplier.put("Defence multiplier", 1.00f);
        this.multiplier.put("Intelligence multiplier", 1.20f);
        this.multiplier.put("Dexterity multiplier", 1.05f);
        this.multiplier.put("Agility multiplier", 1.02f);
        this.multiplier.put("Speed multiplier", 1.00f);
    ...
    public Float getDmg(){
        ...
        Float percentage = (getIntelligence() * 0.015f);
        if(random <= percentage){
            return(float)Math.round((getIntelligence() * 2 + random2) * 100)/ 100;
        }
        else {
            return (float)Math.round((getIntelligence() + random2) * 100) / 100;
        }
    }
    ...
    public void addDefence(Integer points) {
        if(this.points >= points){
            ...
            setHp((float)Math.round((getHp() + (getDefence() / 3) + points)  * 100.0f) / 100.0f);
        }
    }
